        ...
        async (data: Form) => {
            try {
                ...
                const unsignedTx = await commit({
                    ...
                    isCreator: true,
                    status: dataStatus?.toString().toUpperCase() as string,
                });
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogDescription>
                                                            You need to commit more than 10 ADA to register as a proposal. This amount will be
                                                            refunded when the session ends.
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                        ...
                        >
                            <div className="space-y-6 flex flex-col">
                                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }}>
                                    <Balance proposal={data?.data} walletAddress={address as string} assetName={data.data?.author as string} />
                                </motion.div>
